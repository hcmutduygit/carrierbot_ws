#include "my_robot_cpp_example/simple_tf_kinematics.hpp"
    ...
    , last_x_(0.0)
{
    ...
    static_transform_stamped_.header.frame_id = "base_link";
    static_transform_stamped_.child_frame_id = "upper_base_link";
...
void SimpleTfKinematics::timerCallback()
{
    ...
    dynamic_transform_stamped_.child_frame_id = "base_link";
