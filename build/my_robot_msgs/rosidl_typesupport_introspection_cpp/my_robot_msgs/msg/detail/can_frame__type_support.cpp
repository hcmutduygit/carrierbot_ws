...
{
  new (message_memory) my_robot_msgs::msg::CanFrame(_init);
}

void CanFrame_fini_function(void * message_memory)
{
  auto typed_message = static_cast<my_robot_msgs::msg::CanFrame *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember CanFrame_message_member_array[2] = {
  {
    ...
    offsetof(my_robot_msgs::msg::CanFrame, can_id),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(my_robot_msgs::msg::CanFrame, data),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers CanFrame_message_members = {
  ...
  2,  // number of fields
  sizeof(my_robot_msgs::msg::CanFrame),
...
get_message_type_support_handle<my_robot_msgs::msg::CanFrame>()
{
  return &::my_robot_msgs::msg::rosidl_typesupport_introspection_cpp::CanFrame_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, my_robot_msgs, msg, CanFrame)() {
  return &::my_robot_msgs::msg::rosidl_typesupport_introspection_cpp::CanFrame_message_type_support_handle;
}
