...
bool my_robot_msgs__msg__can_frame__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("my_robot_msgs.msg._can_frame.CanFrame", full_classname_dest, 37) == 0);
  }
  my_robot_msgs__msg__CanFrame * ros_message = _ros_message;
  {  // can_id
...
PyObject * my_robot_msgs__msg__can_frame__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("my_robot_msgs.msg._can_frame");
