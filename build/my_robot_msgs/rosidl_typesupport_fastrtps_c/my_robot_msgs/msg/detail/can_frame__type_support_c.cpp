...
#include "my_robot_msgs/msg/detail/can_frame__rosidl_typesupport_fastrtps_c.h"
...
using _CanFrame__ros_msg_type = my_robot_msgs__msg__CanFrame;
...
size_t get_serialized_size_my_robot_msgs__msg__CanFrame(
  const void * untyped_ros_message,
...
static uint32_t _CanFrame__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_my_robot_msgs__msg__CanFrame(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_my_robot_msgs
size_t max_serialized_size_my_robot_msgs__msg__CanFrame(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = my_robot_msgs__msg__CanFrame;
    is_plain =
      (
...
static size_t _CanFrame__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_my_robot_msgs__msg__CanFrame(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, my_robot_msgs, msg, CanFrame)() {
