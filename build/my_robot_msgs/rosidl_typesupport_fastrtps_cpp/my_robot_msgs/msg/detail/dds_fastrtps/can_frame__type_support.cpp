...
#include "my_robot_msgs/msg/detail/can_frame__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const my_robot_msgs::msg::CanFrame & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  my_robot_msgs::msg::CanFrame & ros_message)
{
  // Member: can_id
  cdr >> ros_message.can_id;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = my_robot_msgs::msg::CanFrame;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const my_robot_msgs::msg::CanFrame *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<my_robot_msgs::msg::CanFrame *>(
    untyped_ros_message);
...
{
  return &my_robot_msgs::msg::typesupport_fastrtps_cpp::_CanFrame__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, my_robot_msgs, msg, CanFrame)() {
  return &my_robot_msgs::msg::typesupport_fastrtps_cpp::_CanFrame__handle;
}
