...
static const _CanFrame_type_support_symbol_names_t _CanFrame_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, my_robot_msgs, msg, CanFrame)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, my_robot_msgs, msg, CanFrame)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, my_robot_msgs, msg, CanFrame)() {
  return &::my_robot_msgs::msg::rosidl_typesupport_c::CanFrame_message_type_support_handle;
}
